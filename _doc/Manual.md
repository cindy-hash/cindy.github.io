...
```yml
# Site settings
title: Cindy Blog             # title of your website
SEOTitle: Cindy Blog          # check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“Cindy Blog”** but I want the title shows in search engine is **“黄玄的博客 | Cindy Blog”** which is multi-language.
